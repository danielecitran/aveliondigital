      ...
      <div className="relative mx-auto w-full max-w-[1440px] px-6 pb-20 pt-20 sm:px-10 sm:pb-24 sm:pt-24 lg:px-16 lg:pb-28 lg:pt-28">
        ...
        <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {Array.from({ length: 6 }).map((_, i) => (
            <div
              key={i}
              className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/[0.06] p-5 shadow-[0_12px_45px_rgba(0,0,0,0.45)] backdrop-blur-md transition will-change-transform hover:-translate-y-0.5 hover:bg-white/[0.085]"
            >
